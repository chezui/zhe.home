...
* **Human Feedback and Preference Systems**: Owned the design and rollout of Snapchat’s first large-scale, content-level in-app survey system, defining preference dimensions, ceiling tests, and response models to convert user feedback into durable learning signals.
* **LLM Evaluation and Standards**: Established evaluation methodology and reference tooling for LLM-powered content understanding, including preference-based metrics, slice-level analysis, and model–human disagreement diagnostics used to guide deployment and iteration decisions.
* **Content Quality and Ranking Systems**: Set the technical direction for integrating human feedback, LLM-based understanding, and evaluation signals into short-form video and Discover ranking and policy decisions.
* **Content Ecosystem Strategy**: Defined content quality and ranking strategy at the ecosystem level by translating human preference signals and model evaluation insights into executive decisions on product direction, growth tradeoffs, and platform health.
