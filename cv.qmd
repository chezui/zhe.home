...
**Quantitative:** Machine Learning, MLOps,tatistics, Optimization, Large-scale Data Analysis, Causal Inference, Design of Experiments, Large Language Models, Data Modeling/ETL
...
* **Strategic Insights**: Recommendations to CEO, CFO, VPsand other senior leadership on product direction and business impact.
...
* **Resource Allocation in Backhaul-Constrained Small Cell Networks**: Developed distributed algorithms in MATLAB and Python for cooperative resource allocation in 5G networks. Published and presented at CISS 2014 ([link](https://ieeexplore.ieee.org/abstract/document/6814100)).
